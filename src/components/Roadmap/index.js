        ...
        <Flex mx='auto' bg='primary' width='100%' justify='center' direction='column' >
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" left="120px">
                    <Heading fontSize="xl" color="white">GIVEAWAY</Heading>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" right="120px">
                    <Heading fontSize="xl" color="white">Secret and private investment</Heading>
                    <Text mt="2" color="white">Get into the system and gain access to private and secret investment opportunities :‍</Text>
                    <Text mt="2" color="white">Real estate off market deals, access early rounds investment in startups, angel investing, Launchpad ICOs, IDOs, etc ...</Text>
                </Flex>
            </Flex>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" right="120px">
                    <Heading fontSize="xl" color="white">Charity</Heading>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" left="120px">
                    <Heading fontSize="xl" color="white">MORE THAN A BRAND, CYBORG 86</Heading>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" right="120px">
                    <Heading fontSize="xl" color="white">SPONSORSHIPS</Heading>
                    <Text mt="2" color="white">‍Millions of people appropriated our image to the point of becoming a brand : Cyborg 86.</Text>
                    <Text mt="2" color="white">Today you have the opportunity to be the first ambassadors.</Text>
                    <Text mt="2" color="white">Today you have the opportunity to be the first ambassadors.</Text>
                </Flex>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" left="120px">
                    <Heading fontSize="xl" color="white">$860,000 IN FUNDS</Heading>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" right="120px">
                    <Heading fontSize="xl" color="white">$1,000,000 IN REWARDS FOR OUR HOLDERS</Heading>
            ...
            <Flex justify="center">
                <Flex direction="column" w="600px" pos="relative" right="120px">
                    <Heading fontSize="xl" color="white">BRAIN 3.0 - THE REVOLUTION STARTS NOW</Heading>
