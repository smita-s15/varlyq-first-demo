...
const TopShapeRoadMap = (props) => {
    return <Flex justify="center" {...props}>
        <Flex direction="column" minW={{ sm: "260px", md: "350px" }}     >
            <Flex justify={{ sm: "center", md: "flex-end" }} minW={{ sm: "260px", md: "350px" }}   >
                <Flex width={{ sm: "80px", md: "240px" }} height={{ sm: "120px", md: "240px" }} borderRight="3px solid #052FC2" borderBottom="3px solid #052FC2" borderBottomRightRadius="50%"  >
                </Flex>
            </Flex>
            <Flex >
                <Flex w="50%" h="100px" mt="-3px" borderTop="3px solid #052FC2" borderLeft="3px solid #052FC2" borderTopLeftRadius="95px"  >
                </Flex>
            </Flex>
        </Flex>
    </Flex>
...
const DataComponent = (props) => {
    ...
    return <Flex direction="column" p="10" {...rest} overflow="hidden" data-aos="zoom-in"  >
        <Heading fontSize={{ sm: '12px', md: "20px", lg: '25px', xl: '30px' }} color="white" >{heading}</Heading>
        <Flex mt='10px' direction='column' w='80%' fontSize={{ sm: '7px', md: '12px', lg: '14px', xl: '16px' }} >
...
const arr = [
    {
        ...
        DataComponentOne: <DataComponent w={{ base: "250px", md: "500px", xl: '700px' }} pos="absolute" top="-25px" align="flex-start" textAlign="start"
            heading="Giveway"
        ...
        DataComponentTwo: <DataComponent w={{ base: "250px", md: "500px", xl: '700px' }} pos="absolute" top="-25px" align="flex-end" textAlign="end"
    ...
    },
    {
        ...
        DataComponentTwo: <DataComponent w={{ base: "250px", md: "500px", xl: '700px' }} pos="absolute" top="-20px" align="flex-end" textAlign="end"
            heading="Charity"
    ...
    },
    {
        ...
        DataComponentTwo: <DataComponent w={{ base: "250px", md: "500px", xl: '800px' }} pos="absolute" top="-20px" align="flex-end" textAlign="end"
            heading="Sponsorship"
