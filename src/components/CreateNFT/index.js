...
export const CreateNFT = () => {
    return (
        <Flex w="100%" direction='column' justify="center" my="20" mx='auto' align='center'  >
             <Button bg='#052FC2' color='secondary' p={2} w='186px' h='55px' borderRadius={20} shadow={1} mt={10} fontSize='15px' mt={1}>Explore</Button>
            ...
            <Stack direction='row' w='60%'  justify='space-between' spacing={20} mt={20}>
                    {NFTArr.map((item) => <NFTCard image={item.image} title={item.title} ether={item.ether} />)}
            </Stack>
            <Stack direction='row' justify='space-between' spacing={10} align='center' mt={20}>
                <Button bg='#052FC2' color='secondary' p={2} w='186px' h='55px' borderRadius={20} shadow={1} mt={10} fontSize='15px' mt={1}>Create</Button>
                <Button  bg='transparent' color='white' borderColor='secondary' border='1px' p={2} w='186px' h='55px' borderRadius={20} shadow={1} mt={10} fontSize='15px' mt={1}>Watch Video</Button>
            </Stack>
...
const NFTCard = ({ image, title, ether }) => <Flex bg="#101112" direction='column' w='100%' align='center' textColor='white' borderRadius={20} p={10} align='center' >
